...
using Saesentsessis.Persistence.Installer.SimpleJSON;

namespace Saesentsessis.Persistence.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/Saesentsessis.Persistence.Installer.Tests/test_manifest.json";
        const string PackageId = "com.saesentsessis.unity-data-shards";
